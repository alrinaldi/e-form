          ...
          <div class="row">
            <div class="col-xl-12 grid-margin-lg-0 grid-margin stretch-card">
              <div class="card">
                ...
                <p class="pt-3"></p>
                    <h4 class="card-title">Workflow Vendor</h4>
    ...
    $('.check_all').click(function() {
        ...
        $('#submit_item').click(function(){
			...
			function tampil_item() {
				$.ajax({
					type: 'ajax',
					url:'<?php echo site_url('admin/c_workflow/tampil_workflow_vend')?>',
					async: false,
					dataType: 'json',
            ...
            $('#btn_save').on('click',function(){
                ...
                $.ajax({
                    type : "POST",
                    url : "<?php echo site_url('admin/c_workflow/save_flow_vend')?>",
                    dataType: "JSON",
