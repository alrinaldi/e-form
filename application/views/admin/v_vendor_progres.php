    ...
    <thead style="background-color:orange !important;color:black" class="text-center font-weight-bold">
                  ...
                  <?php 
                     // $vndu = $this->session->userdata('nrp');
                      $vnd = $this->db->query("SELECT * FROM vendor where status <> 'Completed' ");
                  ...
                  <tr>
                    ...
                    <td>          
                        <a class="btn" data-toggle="modal" data-target="#ModalEdit<?php echo $v['id_vendor'];?>"><span class="fa fa-edit"></span></a>
                        </td>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
                   ...
                   <thead style="background-color:orange !important;color:black" class="text-center font-weight-bold">
                        <tr>
                            <?php  
                            $aprv = $this->db->query("SELECT * FROM WORKFLOW_VENDOR ORDER BY CONVERT(SUBSTRING(step,9,3), SIGNED INTEGER)");
                    ...
                    <p class="pt-3"></p>
                    <?php 
                    $naprv = $this->db->query("SELECT a.*,b.* FROM workflow_vendor a join sstruktur_ymi b on a.flow_name = b.costcenter  ORDER BY CONVERT(SUBSTRING(step,9,3), SIGNED INTEGER) ");
