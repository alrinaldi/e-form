...
?>
  ...
  <div class="form-group row">
    ...
    <div class="col-md-10">
      <input type="text"  name="id_master" class="form-control-plaintext" id="" value="<?php echo $id_vendor?>" >
    </div>
  </div>
  <div class="form-group row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Requestor</label>
    <div class="col-md-10">
      <input type="text" name="requestor" class="form-control" id="inputPassword" value="<?php echo $nrp?>" >
    </div>
  </div>
  <div class="form-group row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Segment</label>
    <div class="col-md-10">
      <input type="text" name="segment" class="form-control" id="inputPassword" value="<?php echo $segment?>" >
    </div>
  </div>
  <div class="form-group row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Nama</label>
    <div class="col-md-10">
      <input type="text" name="nama"class="form-control" id="inputPassword" value="<?php echo $nama?>" >
    </div>
  </div>
  <div class="form-group row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Address (SK Domisili/SUP)</label>
    <div class="col-md-10">
      <input type="text" name="address" class="form-control" id="inputPassword" value="<?php echo $address?>" >
    </div>
  </div>
  <div class="form-group row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Phone (Fixed Line)</label>
    <div class="col-md-10">
      <input type="text" name="phone" class="form-control" id="inputPassword" value="<?php echo $phone?>" >
    </div>
  </div>
  <div class="form-group row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Fax</label>
    <div class="col-md-10">
      <input type="text" name="fax" class="form-control" id="inputPassword" value="<?php echo $fax?>" >
    </div>
  </div>
  <div class="form-group row">
    <label for="inputPassword" class="col-sm-2 col-form-label">E-mail</label>
    <div class="col-md-10">
      <input type="text" name ="mail" class="form-control" id="inputPassword" value="<?php echo $email?>" >
    </div>
  </div>
  <div class="form-group row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Name or Description</label>
    <div class="col-md-10">
      <input type="text" name="desc" class="form-control" id="inputPassword" value="<?php echo $description?>" >
    </div>
  </div>
  <div class="form-group row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Country/Region</label>
    <div class="col-md-10">
      <input type="text" name="region" class="form-control" id="inputPassword" value="<?php echo $country?>" >
    </div>
  </div>
  <div class="form-group row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Contact Information</label>
    <div class="col-md-10">
      <input type="text" name="contact" class="form-control" id="inputPassword" value="<?php echo $contact?>" >
    </div>
  </div>
  <div class="form-group row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Currency</label>
    <div class="col-md-10">
      <input type="text" name="currency" class="form-control" id="inputPassword" value="<?php echo $currency?>" >
    </div>
  </div>
  <div class="form-group row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Lampiran</label>
    <div class="col-md-10">
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#lampirm" id="btn-lamp" data-id="<?php echo $id_vendor?>">Lampiran</button>
</div>
  </div>
...
<div class="card">
  ...
  <div class="form-group row">
    ...
    <div class="col">
      <input type="date" class="form-control" id="inputEmail3" name="tgl_siup" value="<?php echo $tglsiup?>">
    </div>
    <label for="inputEmail3" class="col-form-label">Masa Berlaku s/d :</label>
    <div class="col ">
      <input type="date" class="form-control" id="inputEmail3" name="m_siup" value="<?php echo $tglsiup?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <label for="inputEmail3" class="col-sm-1 col-form-label">Tanggal    :</label>
    <div class="col">
      <input type="date" class="form-control" id="inputEmail3" name="tgl_situ" value="<?php echo $tglsitu?>">
    </div>
    <label for="inputEmail3" class="col-form-label">Masa Berlaku s/d :</label>
    <div class="col">
      <input type="date" class="form-control" id="inputEmail3" name="m_situ" value="<?php echo $masaidndir?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <label for="inputEmail3" class="col-sm-1 col-form-label">Tanggal    :</label>
    <div class="col">
      <input type="date" class="form-control" id="inputEmail3" name="tgl_tdp" value="<?php echo $tgltdp?>">
    </div>
    <label for="inputEmail3" class="col-form-label">Masa Berlaku s/d :</label>
    <div class="col">
      <input type="date" class="form-control" id="inputEmail3" name="m_tdp" value="<?php echo $masatdp?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <label for="inputEmail3" class="col-sm-1 col-form-label">Tanggal    :</label>
    <div class="col">
      <input type="date" class="form-control" id="inputEmail3" name="tgl_idir" value="<?php echo $tglidndir?>">
    </div>
    <label for="inputEmail3" class="col-form-label">Masa Berlaku s/d :</label>
    <div class="col">
      <input type="date" class="form-control" id="inputEmail3" name="m_idir" value="<?php echo $masaidndir?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <label for="inputEmail3" class="col-sm-1 col-form-label">Tanggal    :</label>
    <div class="col">
      <input type="date" class="form-control" id="inputEmail3" name="tgl_aktapdir" value="<?php echo $tglaktants?>">
    </div>
    <label for="inputEmail3" class="col-form-label">Masa Berlaku s/d :</label>
    <div class="col">
      <input type="date" class="form-control" id="inputEmail3" name="m_aktapdir" value="<?php echo $masaaktants?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col">
      <input type="number" class="form-control" id="inputEmail3" name="kontrak" value="<?php echo $nokontrak?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col">
      <input type="date" class="form-control" id="inputEmail3" name="tgl_kontrak" value="<?php echo $tglkontrak?>">
    </div>
  </div>
<hr>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <label for="inputEmail3" class="col-sm-1 col-form-label">Tanggal    :</label>
    <div class="col">
      <input type="date" class="form-control" id="inputEmail3" name="tgl_sppkp" value="<?php echo $tglsppkp?>">
    </div>
    <label for="inputEmail3" class="col-form-label">Masa Berlaku s/d :</label>
    <div class="col">
      <input type="date" class="form-control" id="inputEmail3" name="m_sppkp" value="<?php echo $masasppkp?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <label for="inputEmail3" class="col-sm-1 col-form-label">Tanggal    :</label>
    <div class="col">
      <input type="date" class="form-control" id="inputEmail3" name="tgl_aktat" value="<?php echo $tglaktaprbhntrkhr?>">
    </div>
    <label for="inputEmail3" class="col-form-label">Masa Berlaku s/d :</label>
    <div class="col">
      <input type="date" class="form-control" id="inputEmail3" name="m_aktat" value="<?php echo $masaaktaprbhntrkhr ?>">
    </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <div class="form-check">
            ...
            if($lsppkp==1){
            ?>
           <input class="form-check-input" type="checkbox" name="lsppkp" id="gridRadios1" value="1" checked >
<?php
            }else{

            
?>
          <input class="form-check-input" type="checkbox" name="lsppkp" id="gridRadios1" value="1" >
          <?php
            }
          ?>
          <label class="form-check-label" for="gridRadios1">
        ...
        <?php 
            if($laktadir==1){
            ?>
           <input class="form-check-input" type="checkbox" name="laktadir" id="gridRadios2" value="1" checked >
<?php
            }else{

            
?>
          <input class="form-check-input" type="checkbox" name="laktadir" id="gridRadios2" value="1" >
          <?php
            }
          ?>
          <label class="form-check-label" for="gridRadios2">
        ...
        <?php 
            if($lidir==1){
            ?>
           <input class="form-check-input" type="checkbox" name="lidir" id="gridRadios3" value="1" checked >
<?php
            }else{

            
?>
          <input class="form-check-input" type="checkbox" name="lidir" id="gridRadios3" value="1" >
          <?php
            }
          ?>
          <label class="form-check-label" for="gridRadios3">
        ...
        <?php 
            if($lad==1){
            ?>
           <input class="form-check-input" type="checkbox" name="lad" id="gridRadios4" value="1" checked >
<?php
            }else{

            
?>
          <input class="form-check-input" type="checkbox" name="lad" id="gridRadios4" value="1"  >
          <?php
            }
          ?>
          <label class="form-check-label" for="gridRadios4">
        ...
        <?php 
            if($lsitu==1){
            ?>
           <input class="form-check-input" type="checkbox" name="lsitu" id="gridRadios4" value="1" checked >
<?php
            }else{

            
?>
          <input class="form-check-input" type="checkbox" name="lsitu" id="gridRadios4" value="1"  >
          <?php
            }
          ?>
          <label class="form-check-label" for="gridRadios4">
        ...
        <?php 
            if($ltdp==1){
            ?>
           <input class="form-check-input" type="checkbox" name="ltdp" id="gridRadios5" value="1" checked >
<?php
            }else{

            
?>
          <input class="form-check-input" type="checkbox" name="ltdp" id="gridRadios5" value="1"  >
          <?php
            }
          ?>
          <label class="form-check-label" for="gridRadios5">
        ...
        <?php 
            if($laktat==1){
            ?>
           <input class="form-check-input" type="checkbox" name="laktat" id="gridRadios6" value="1" checked >
<?php
            }else{

            
?>
          <input class="form-check-input" type="checkbox" name="laktat" id="gridRadios6" value="1"  >
          <?php
            }
          ?>
          <label class="form-check-label" for="gridRadios6">
        ...
        <?php 
            if($lsiup==1){
            ?>
           <input class="form-check-input" type="checkbox" name="lsiup" id="gridRadios6" value="1" checked >
<?php
            }else{

            
?>
          <input class="form-check-input" type="checkbox" name="lsiup" id="gridRadios6" value="1"  >
          <?php
            }
          ?>
          <label class="form-check-label" for="gridRadios6">
        ...
        <?php 
            if($lnpwp==1){
            ?>
           <input class="form-check-input" type="checkbox" name="lnpwp" id="gridRadios6" value="1" checked >
<?php
            }else{

            
?>
          <input class="form-check-input" type="checkbox" name="lnpwp" id="gridRadios6" value="1"  >
          <?php
            }
          ?>
          <label class="form-check-label" for="gridRadios6">
        ...
        <?php 
            if($lrefbank==1){
            ?>
           <input class="form-check-input" type="checkbox" name="lrefbank" id="gridRadios6" value="1" checked >
<?php
            }else{

            
?>
          <input class="form-check-input" type="checkbox" name="lrefbank" id="gridRadios6" value="1"  >
          <?php
            }
          ?>
          <label class="form-check-label" for="gridRadios6">
        ...
        <?php 
            if($lpakte==1){
            ?>
           <input class="form-check-input" type="checkbox" name="lpakte" id="gridRadios6" value="1" checked >
<?php
            }else{

            
?>
          <input class="form-check-input" type="checkbox" name="lpakte" id="gridRadios6" value="1"  >
          <?php
            }
          ?>
          <label class="form-check-label" for="gridRadios6">
        ...
        <?php 
            if($lpaktet==1){
            ?>
           <input class="form-check-input" type="checkbox" name="lpaktet" id="gridRadios6" value="1" checked >
<?php
            }else{

            
?>
          <input class="form-check-input" type="checkbox" name="lpaktet" id="gridRadios6" value="1"  >
          <?php
            }
          ?>
          <label class="form-check-label" for="gridRadios6">
        ...
        <?php 
            if($lsrekan==1){
            ?>
           <input class="form-check-input" type="checkbox" name="lsrekan" id="gridRadios6" value="1" checked >
<?php
            }else{

            
?>
          <input class="form-check-input" type="checkbox" name="lsrekan" id="gridRadios6" value="1"  >
          <?php
            }
          ?>
          <label class="form-check-label" for="gridRadios6">
        ...
        <?php 
            if($lhrd==1){
            ?>
           <input class="form-check-input" type="checkbox" name="lhrd" id="gridRadios6" value="1" checked >
<?php
            }else{

            
?>
          <input class="form-check-input" type="checkbox" name="lhrd" id="gridRadios6" value="1"  >
          <?php
            }
          ?>
          <label class="form-check-label" for="gridRadios6">
        ...
        <?php 
            if($lpp==1){
            ?>
           <input class="form-check-input" type="checkbox" name="lpp" id="gridRadios6" value="1" checked >
<?php
            }else{

            
?>
          <input class="form-check-input" type="checkbox" name="lpp" id="gridRadios6" value="1"  >
          <?php
            }
          ?>
          <label class="form-check-label" for="gridRadios6">
        ...
        <?php 
            if($lmdir==1){
            ?>
           <input class="form-check-input" type="checkbox" name="lmdir" id="gridRadios6" value="1" checked >
<?php
            }else{

            
?>
          <input class="form-check-input" type="checkbox" name="lmdir" id="gridRadios6" value="1"  >
          <?php
            }
          ?>
          <label class="form-check-label" for="gridRadios6">
        ...
        <?php 
            if($lpk==1){
            ?>
           <input class="form-check-input" type="checkbox" name="lpk" id="gridRadios6" value="1" checked >
<?php
            }else{

            
?>
          <input class="form-check-input" type="checkbox" name="lpk" id="gridRadios6" value="1"  >
          <?php
            }
          ?>
          <label class="form-check-label" for="gridRadios6">
        ...
        <?php 
            if($lskeb==1){
            ?>
           <input class="form-check-input" type="checkbox" name="lskeb" id="gridRadios6" value="1" checked >
<?php
            }else{

            
?>
          <input class="form-check-input" type="checkbox" name="lskeb" id="gridRadios6" value="1"  >
          <?php
            }
          ?>
          <label class="form-check-label" for="gridRadios6">
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <div class="form-check">
            ...
            if($lsiujk==1){
            ?>
           <input class="form-check-input" type="checkbox" name="lsiujk" id="gridRadios1" value="1" checked >
<?php
            }else{

            
?>
          <input class="form-check-input" type="checkbox" name="lsiujk" id="gridRadios1" value="1" >
          <?php
            }
          ?>
          <label class="form-check-label" for="gridRadios1">
        ...
        <?php 
            if($lkonstruksi==1){
            ?>
           <input class="form-check-input" type="checkbox" name="lkonstruksi" id="gridRadios2" value="1" checked >
<?php
            }else{

            
?>
          <input class="form-check-input" type="checkbox" name="lkonstruksi" id="gridRadios2" value="1" >
          <?php
            }
          ?>
          <label class="form-check-label" for="gridRadios2">
  ...
  <button type="submit" class="btn btn-primary">Update Legal Vendor</button>
  ...
  <div class="btn-group-vertical pull-right">
    ...
    ?>
  <a href="<?php echo base_url('admin/c_apv_vend/aprv_vend/'.$id)?>" class="btn btn-primary" onclick="return confirm('Approve Vendor ?')">Approve</a>
  <?php
      }
  ?>
  </div>
  ...
  <div class="modal fade" id="lampirm" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Lampiran</h5>
...
$('#lampirm').on('show.bs.modal', function (event) {
              ...
              //  $('#edit_item').val(id_vendor);
                ...
                $.ajax({
                    type: "POST",
                    url : '<?php echo site_url('admin/c_apv_vend/tampil_file')?>',
                    async:false,
                    dataType:'json',
