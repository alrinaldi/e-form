...
?>
  ...
  <div class="btn-group-vertical pull-right">
    <input type="hidden" name="id_vendor_l" id="id_vendor_l" value ="<?php echo $id ?>" >
      <?php
      $nrp = $this->session->userdata('nrp');
      $cek = $this->db->query("SELECT * FROM approval_master_vendor where id_master_vendor = '$id_vendor' and approval = '$nrp'");
      if($cek->num_rows()>0){
          ?>
    <button class="btn btn-primary float-right" disabled>Approve</button>
    <button class="btn btn-danger float-right mr-3" id="reject_btn" >Reject</button>
    <?php
      }else{
    ?>
  <a href="<?php echo base_url('user/c_vendor_legal/aprv_vend/'.$id)?>" class="btn btn-primary" onclick="return confirm('Approve this data ?')">Approve</a>
  <button class="btn btn-danger float-right mr-3" id="reject_btn" >Reject</button>
...
*/
            ...
            $('#reject_btn').on('click',function(){
              ...
              var id_master_form = $('#id_vendor_l').val();
             ...
             if (command == null) {
              ...
              $.ajax({
                type:'POST',
                url:'<?php echo site_url('user/c_vendor_legal/reject_vend')?>',
                dataType:'JSON',
