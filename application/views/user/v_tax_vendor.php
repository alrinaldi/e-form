          ...
          <div class="row">
            <div class="col-xl-12 grid-margin-lg-0 grid-margin stretch-card">
              <div class="card">
                ...
                <button class="btn btn-danger float-right" id="reject_btn">Reject</button>
       ...
       return false;
        ...
        $('#submit_item').click(function(){
			...
			function tampil_item() {
				$.ajax({
					type: 'ajax',
					url:'<?php echo site_url('user/c_assign_vendor/tax_vendor')?>',
					async: false,
					dataType: 'json',
					success: function (data) {
						...
						for (i = 0; i < data.length; i++) {
                            html += '<tr id="' + data[i].id_vendor + '">' +
                                '<td>'+
                                '<input type="checkbox" name="id_number[]" class="form-control chk_boxes1" value="'+data[i].id_vendor+'"/>'+
                                '</td>'+
								...
								'<td>' + data[i].nama + '</td>' +
								 '<td>'+
                                 '<a class="btn btn-primary" href="<?php echo base_url();?>user/c_assign_vendor/detail_form/'+data[i].id_vendor+'" target="_blank"><span class="fa fa-edit"></span></a>'+
                                '</td>' +
                                '</tr>'
