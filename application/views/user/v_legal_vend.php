            ...
            <div class="col-xl-12 grid-margin-lg-0 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <tr>
                  <th style="width:30px">Select<input type="checkbox" class="form-control check_all" style="width:20px"/></th>
    ...
    $('.check_all').click(function() {
        ...
        $('#submit_itemz').click(function(){
			...
			function tampil_item() {
				$.ajax({
					type: 'ajax',
					url:'<?php echo site_url('user/c_vendor_legal/legal_vendor')?>',
					async: false,
					dataType: 'json',
					success: function (data) {
						...
						for (i = 0; i < data.length; i++) {
                            html += '<tr id="' + data[i].id_vendor + '">' +
								...
								'<td>' + data[i].nama + '</td>' +
								 '<td>'+
                                 '<a class="btn btn-primary" href="<?php echo base_url();?>user/c_vendor_legal/detail_vend/'+data[i].id_vendor+'" target="_blank"><span class="fa fa-edit"></span></a>'+
                                '</td>' +
                                '</tr>'
